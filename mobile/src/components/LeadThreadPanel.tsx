...
const ACTIVITY_ICONS: Record<string, React.ComponentProps<typeof Ionicons>['name']> = {
  ...
  lead_transfer_requested: 'swap-horizontal-outline',
  lead_transferred: 'swap-horizontal-outline',
  lead_transfer_declined: 'close-circle-outline',
  lead_transfer_cancelled: 'arrow-undo-outline',
